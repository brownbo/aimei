    ...
    $.extend({
        artwl_bind: function (options) {
            ...
            var cssCode = 'html, body, h1, h2, h3, h4, h5{margin: 0px;padding: 0px;}\
                            #artwl_mask{background-color: #000;position: fixed;top: 0px;left: 0px;z-index:2000;width: 100%;height: 100%;opacity: 0.5;filter: alpha(opacity=50);display: none;}\
                            ...
                            #artwl_title{position: relative;z-index:2004;height: 27px;border-bottom: 1px solid #999;}\
                            #artwl_close{position: absolute;cursor: pointer;outline: none;top: 0;right: 0;z-index: 2004;width: 42px;height: 42px;overflow: hidden;background-image: url(js/feedback-close.png);_background: none;}\
